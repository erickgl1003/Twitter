...
<img src='https://github.com/erickgl1003/Twitter/blob/master/DemoVideo.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [Kap](https://getkap.co/).

## Notes

* Some functions in the Floating Action Button guide were deprecated and had to search in other sources, but it eventually worked out!
